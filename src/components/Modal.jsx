...
const Modal = ({setShowModal=()=>{}, children}) => {
	...
	return createPortal(
        <>
            ...
            <div className="rounded-lg fixed top-1/2 left-1/2 w-2/3 text-xl font-bold transparent-white lg:p-10 p-10 z-10 flex justify-center" style={{transform: "translate(-50%, -50%)"}}>
                {children}
            </div>
        </>,
