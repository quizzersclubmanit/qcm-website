  ...
  return (
    <div id="hero" className="h-screen flex flex-col sm:flex-row items-center justify-evenly londrina-solid-regular">
      <div className="left w-full h-full my-[10vh] sm:my-0 sm:w-2/3 flex flex-col items-center justify-center text-white gap-3">
        <h1 className="sm:text-[9vmax] text-[11vmax]" style={{WebkitTextStrokeWidth: "3px", WebkitTextStrokeColor: "#00aded"}}>{org}</h1>
        <h4 className="text-[5vmax]" style={{WebkitTextStrokeWidth: "2px", WebkitTextStrokeColor: "black"}}>NIT Bhopal</h4>
        <p className="sm:text-[2vmax] text-[4vmax]" style={{WebkitTextStrokeWidth: "1px", WebkitTextStrokeColor: "black"}}>
          Central India's <span className="text-yellow-400 sm:text-[3vmax] text-[3.5vmax]">Largest Quizzing Club</span>
        </p>
      </div>
